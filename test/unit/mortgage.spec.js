...
describe('Mortgage Calculator', () => {
    ...
    it('should calculate monthly interest rate correctly', () => {
      expect(mortgage.monthlyInterestRate(4, 10)).to.equal(0.0040000000);
    });
    ...
    it('should calculate the compounded interest rate correctly', () => {
      expect(mortgage.compoundedInterestRate(0.0040000000, 100)).to.equal(1.490634885647868);
    });

    it('should have an interestQuotient function', () => {
      expect(mortgage.interestQuotient).to.exist;
    });

    it('should calculate the interest quotient correctly', () => {
      expect(mortgage.interestQuotient(0.0040000000, 1.490634885647868, 100)).to.equal(0.012152701972502681);
    });
